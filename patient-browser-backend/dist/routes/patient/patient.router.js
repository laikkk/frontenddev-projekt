    ...
    constructor(patientDataSource) {
        ...
        this.addPatient = (req, res, next) => {
            ...
            if (req.body.name && req.body.surname) {
                let patient = new patient_datasource_1.Patient(id, req.body.name, req.body.surname, req.body.imageURL);
        ...
        this.updatePatient = (req, res, next) => {
            if (req.body.id && req.body.name && req.body.surname) {
                let patient = new patient_datasource_1.Patient(req.body.id, req.body.name, req.body.surname, req.body.imageURL);
        ...
        this.removePatient = (req, res, next) => {
            if (req.params.id) {
                let patient = new patient_datasource_1.Patient(req.params.id, '', '', '');
